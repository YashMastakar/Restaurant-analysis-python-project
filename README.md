...
* **[Zomato_Project.ipynb](./Zomato_Project.ipynb):** The complete Python code, including data cleaning, visualization, and statistical analysis.
* [cite_start]**[Bangalore_Resto_Success_Analysis.pdf](./BLR_Resto_Success_Analysis_Project.pdf):** The comprehensive project report exported from JupyterLab for a quick, readable overview of all findings[cite: 3].

---
*Developed as part of the Data Science curriculum at ITVedant.*
